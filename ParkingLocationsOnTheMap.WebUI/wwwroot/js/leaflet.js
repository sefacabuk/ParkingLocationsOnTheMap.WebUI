...
var KTLeaflet = function () {
	...
	var demo3 = function () {
		...
		// set custom SVG icon marker
		var leafletIcon = L.divIcon({
			html: `<i class="fas fa-2x fa-parking text-primary"></i>`,
			bgPos: [10, 10],
			iconAnchor: [20, 37],
			popupAnchor: [0, -37],
			className: 'leaflet-marker'
		...
		var marker1 = L.marker([41.025600000000054, 28.93784000000005], { icon: leafletIcon }).addTo(leaflet);
		var marker2 = L.marker([41.10005163093046, 28.721008300781254], { icon: leafletIcon }).addTo(leaflet);
		var marker3 = L.marker([41.01712000137991, 28.765169963596946], { icon: leafletIcon }).addTo(leaflet);
		var marker4 = L.marker([41.021250000000066, 29.188010000000077], { icon: leafletIcon }).addTo(leaflet);
